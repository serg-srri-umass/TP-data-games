package odyssey
{
	public class DebugMode
	{
		...
		public static const DISABLE_DROP_BUTTON:Boolean = true;	// true
		
		// when this is set to true, the treasure location prints out to the console.
		public static const PRINT_TREASURE_LOCATION:Boolean = true;  // false
		...
		// when true, there will always be 2 treasures on mission 2.
		public static const ALWAYS_2_TREASURES:Boolean = true; // false
	}
}